...
enum H264Packer {
// SPS/PPS en Annex-B (start code 0x00000001)
...
// SPS/PPS en AVCC (longueur 4 octets)
...
return [UInt8(truncatingIfNeeded: v >> 24), UInt8(truncatingIfNeeded: v >> 16), UInt8(truncatingIfNeeded: v >> 8), UInt8(truncatingIfNeeded: v)]
}
var d = Data()
...
// AVCC → Annex-B (remplace longueurs par startcode)
...
let ok = CMBlockBufferGetDataPointer(dataBuffer, atOffset: 0, lengthAtOffsetOut: &lengthAtOffset,
